...
import { Heart, MessageCircle, Share2, Plus, Camera, Send, X } from 'lucide-react';
				...
				<div className="max-w-2xl mx-auto p-4 space-y-6">
					...
					/>
						...
						<div className="card bg-yellow-50 border border-yellow-200">
							<h3 className="font-bold text-yellow-800 mb-3">{t('postingTips')}</h3>
	...
	return (
		<div className="min-h-screen bg-primary-50">
			...
			<div className="bg-primary-500 text-white px-4 pt-12 pb-6">
				<h1 className="text-2xl sm:text-3xl font-bold mb-2">{t('communityHeader')}</h1>
			...
			<div className="max-w-2xl mx-auto">
				...
				<div className="flex justify-between items-center p-4">
					<h2 className="text-lg font-bold text-primary-500">{t('recentPosts')}</h2>
					<button
